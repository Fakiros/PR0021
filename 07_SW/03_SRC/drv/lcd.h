...
extern volatile const PROGMEM unsigned char LcdCustomChar[16][8];
...
extern void lcd_LoadCustomChar( const PROGMEM   uint8_t  *lcdCustomCharArray, 
							   					uint8_t  romCharNum
							  );


extern void lcd_ProgressBar(uint16_t progress, uint16_t maxprogress, uint8_t length);
